...
export interface QueryOptionsFactory<TParams, TData> {
  (params: TParams): {
    queryKey: QueryKey
...
export interface MutationOptionsFactory<TVars, TData> {
  (opts?: {
...
export interface InfiniteQueryOptionsFactory<TParams, TData> {
  (params: TParams): {
    queryKey: QueryKey
