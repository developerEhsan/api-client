            ...
            onClick={() =>
              run("timeout", async () => {
                ...
                try {
                  ...
                  push("info", e instanceof TimeoutError ? "timeout: caught TimeoutError ✓" : `timeout: ${String(e)}`);
                }
              })
            }
          >
            ...
            onClick={() =>
              run("cancel", async () => {
                ...
                try {
                  ...
                  push("info", isAbortError(e) ? "cancel: caught AbortError ✓" : `cancel: ${String(e)}`);
                }
              })
            }
          >
